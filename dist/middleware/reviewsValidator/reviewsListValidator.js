...
/**
 * Middleware to validate request properties for reviews listing controller.
 * @param req Request
 * @param res Response
 * @param next NextFunction
 * @returns
 */
function reviewsListValidator(req, res, next) {
...
exports.default = reviewsListValidator;
