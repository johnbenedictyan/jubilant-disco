...
const reviewUnLikePrisma_1 = __importDefault(require("../../utils/db/review/reviewUnLikePrisma"));
 ...
 * @returns void
 */
function reviewsUnLike(req, res, next) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // UnLike the review
            const review = yield (0, reviewUnLikePrisma_1.default)(currentUser, slug);
            if (!review)
                return res.sendStatus(404);
            // Retrieve current user after update of its liked reviews
            currentUser = yield (0, userGetPrisma_1.default)(username);
            if (!currentUser)
                return res.sendStatus(500); // The user should not have disappeared after having un-liked an review
            // Create review view
