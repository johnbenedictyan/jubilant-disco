...
const reviewUpdatePrisma_1 = __importDefault(require("../../utils/db/review/reviewUpdatePrisma"));
...
function reviewsUpdate(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // Update the review
            const review = yield (0, reviewUpdatePrisma_1.default)(slug, {
                title,
                description,
                body,
            });
