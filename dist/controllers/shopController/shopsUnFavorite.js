...
const shopUnFavoritePrisma_1 = __importDefault(require("../../utils/db/shop/shopUnFavoritePrisma"));
 ...
 * @returns void
 */
function shopsUnFavorite(req, res, next) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // UnFavorite the shop
            yield (0, shopUnFavoritePrisma_1.default)(currentUser, id);
            // Retrieve current user after update of its favorited shops
            currentUser = yield (0, userGetPrisma_1.default)(username);
            if (!currentUser)
                return res.sendStatus(500); // The user should not have disappeared after having un-favorited an shop
            // Create shop view
...
exports.default = shopsUnFavorite;
